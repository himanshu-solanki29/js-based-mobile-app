...
# Instead of just copying, let's remove the backup files entirely
echo "Removing existing backup files..."
rm -f android/app/src/main/java/com/medicalapp/patienttracker/backups/MainActivity.kt
rm -f android/app/src/main/java/com/medicalapp/patienttracker/backups/MainApplication.kt
...
import com.medicalapp.patienttracker.R
